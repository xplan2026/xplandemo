...
#### 数据库合并与重构
- [x] 合并 demo 和 worker 数据库为统一版本 (v2.0.0)
- [x] 移除白名单和黑客钱包表（项目不需要）
- [x] 保留 auth_nonce（基于官网钱包连接状态）
- [x] 合并钱包配置表（支持 protected/safe/gas 三种类型）
- [x] 更新 Worker 数据库文档和 README
- [x] 删除无用的 demo 目录和旧版数据库脚本

#### 服务器配置与部署
- [x] 获取服务器 SSH 访问权限
- [x] 验证服务器状态 (182.254.180.26, Ubuntu, 83天运行)
- [x] 检查已部署项目目录
- [x] 在服务器上克隆项目代码仓库
- [x] 验证 Nginx 配置和运行状态
- [x] 配置 GitHub Secrets (SSH 密钥、服务器地址)

#### GitHub Actions 配置
- [x] 审查工作流配置文件
- [x] 移除工作流 paths 限制，允许任何推送触发部署
- [x] 推送配置更新到 GitHub
- [x] 配置自动部署到 Ubuntu 服务器

#### 文档更新
- [x] 更新 Supabase/README.md 为 v2.0.0
- [x] 更新数据库架构文档
- [x] 更新项目结构说明
...
### 阶段六：官网部署与代码审计（2026-02-12）

#### 6.1 官网代码审计
- [ ] 审查 `frontend/official-site/` 代码结构
- [ ] 检查环境变量配置
- [ ] 验证 Supabase 连接配置
- [ ] 检查 Nginx 配置文件
- [ ] 检查 GitHub Secrets 配置完整性

#### 6.2 官网部署
- [ ] 配置 official-site 构建流程
- [ ] 部署到 Ubuntu 服务器 (`/var/www/xplan-demo/official-site`)
- [ ] 配置 Nginx 路由规则
- [ ] 测试官网访问功能
- [ ] 验证用户统计功能

#### 6.3 DemoSite 部署（2026-02-11 已配置）
- [x] 配置 GitHub Actions 部署流程
- [x] 移除工作流 paths 限制
- [x] 部署到 Ubuntu 服务器 (`/var/www/xplan-demo/DemoSite`)
- [ ] 测试 DemoSite 完整功能
- [ ] 验证 Worker API 连接
